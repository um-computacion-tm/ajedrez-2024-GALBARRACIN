...
class TestChessMain(unittest.TestCase):
    ...
    def test_initial_turn(self):
        ...
        self.assertEqual(self.game._Chess__current_turn__, 'white', "El turno inicial debe ser de las blancas.")
    ...
    def test_toggle_turn(self):
        ...
        self.assertEqual(self.game._Chess__current_turn__, 'black', "El turno debe alternar a las negras.")
        self.game.toggle_turn()  # Cambia el turno nuevamente
        self.assertEqual(self.game._Chess__current_turn__, 'white', "El turno debe alternar nuevamente a las blancas.")
    ...
    def test_handle_valid_command(self):
        ...
        self.assertIsNone(self.game._Chess__board__.__grid__[6][4], "La posición 'e2' debe estar vacía después del movimiento.")
        self.assertIsNotNone(self.game._Chess__board__.__grid__[4][4], "Debe haber una pieza en 'e4' después del movimiento.")
    ...
    def test_handle_invalid_command(self):
        ...
        self.assertIsNotNone(self.game._Chess__board__.__grid__[7][4], "El rey debe permanecer en la posición 'e1' después del comando inválido.")
    ...
    def test_update_score(self):
        ...
        self.game.update_score(self.game._Chess__board__.__grid__[6][4])  # Peón blanco capturado
        self.assertEqual(self.game._Chess__score__['white'], 1, "El puntaje debe aumentar para las blancas tras capturar una pieza.")

    def test_update_score_with_no_capture(self):
        # Verifica que el puntaje no cambie si no se captura ninguna pieza.
        current_score = self.game._Chess__score__['white']
        self.game.update_score(None)  # No se captura ninguna pieza
        self.assertEqual(self.game._Chess__score__['white'], current_score, "El puntaje no debe cambiar si no se captura ninguna pieza.")
